<template>
    <div class="flex gap-2 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" class='fill-blue-100'>
        ...
        <h1 class="text-nowrap text-[23px] logo hidden md:block">BOOKSHOP</h1>
    </div>
</template>